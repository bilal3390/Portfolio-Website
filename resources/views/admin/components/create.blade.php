                    ...
                    <!-- jquery validation -->
                        <div class="card card-primary">
                            ...
                            <div class="card-header">
                                <h3 class="card-title"><a href="{{route('create')}}"></a></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            ...
                            <form action="" method="post" >
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" class="form-control" placeholder="Ente name">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Code<span style="color: red; font-size: 20px">*</span></label>
                                        <input type="text" name="code" class="form-control" placeholder="Ente Code">
                                    </div>
                                    <!-- /.card-body -->
